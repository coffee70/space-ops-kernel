...
from app.api import bootstrap, change_previews, code, delete, deployments, health, registry, system, templates, validation
...
app.include_router(registry.frontend_shell_proxy_router)
